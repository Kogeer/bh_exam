...
app.get('/interviewer', jobAdvertisementController.interviewerPage.bind(jobAdvertisementController));
app.post('/add-interviewer', jobAdvertisementController.addInterviewer.bind(jobAdvertisementController));
app.get('/choose-interviewer', jobAdvertisementController.chooseInt.bind(jobAdvertisementController));
app.post('/interviewer-statistic', jobAdvertisementController.intStatistic.bind(jobAdvertisementController));
